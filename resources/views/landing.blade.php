...
{{--                                    <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg">--}}
                        ...
                        <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                            ...
                            <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Testmonies</a>
                ...
                <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                    <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                        ...
                        <div class="px-2 pt-2 pb-3 space-y-1">
                            ...
                            <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">get in touch</a>
                        </div>
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            <span class="block xl:inline">Stano darker </span><br>
                        ...
                        <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            want some e-commerce site build for you, get in touch, be sure to check some of our previous work and testimonies
                        </p>
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            <div class="rounded-full bg-dark shadow">
                                <a href="#" class="w-full flex items-center justify-center px-0 py-0 border border-transparent text-base font-medium rounded-full text-white bg-indigo-600 hover:bg-indigo-700 md:py-2 md:text-lg md:px-2">
...
{{--            <img class="h-56 w-full object-cover sm:h-72 md:h-full lg:w-full lg:h-full" src="/images/background.webp" alt="">--}}
            <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="images/home.jpeg" alt="home">
        </div>
    </div>
